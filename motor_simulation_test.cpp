...
void Run_MotorSimulation_Tests() {
    ...
    UT_CheckInRange(motor_get_pot_voltage(), MOTOR_POT_MIN, 0.055, "Initial voltage at min");
    ...
    UT_CheckInRange(v2, MOTOR_POT_MIN, 0.055, "Voltage returns to min after negative PWM");
    ...
    UT_CheckInRange(v_after, v_before, 0.055, "Voltage unchanged with zero PWM");
    ...
    UT_CheckInRange(v_actual, v_expected, 0.055, "Motor moves at correct speed (positive)");
    ...
    UT_CheckInRange(v_max, MOTOR_POT_MAX, 0.055, "Motor saturates at max voltage");
    ...
    UT_CheckInRange(v_min, MOTOR_POT_MIN, 0.055, "Motor saturates at min voltage");
